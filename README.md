...
| [sim_results_analysis.py](src/simulation/sim_results_analysis.py) | Python | Processes raw simulation logs and generates all visualizations, metrics, and analyses used in the report. (Plots stored in `results/`) |
...
| [ucsd_health_simulation_with_predictor.html](src/simulation/ucsd_health_simulation_with_predictor.html) | HTML | Simulation with LOS predictor integrated for transfer decisions. [View HTML output](https://kayannet.github.io/SimHospital/ucsd_health_simulation_with_predictor.html) |
